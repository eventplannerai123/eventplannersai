...
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "cards0918")
...
card(["Thirty RSVPs, four meal","types, nine different","dietary restrictions — and","the caterer needs this","two weeks out."],
     58, 940, "hook_ig.png")
# TikTok hook - command style
card(["Stop hand-counting your","RSVP meal choices."], 68, 940, "hook_tt.png")
# End card - verbatim from the brief
card(["Save this before your next","final count."], 60, 1330, "endcard.png")
