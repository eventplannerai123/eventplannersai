...
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "cards0916")
...
card(["Crazy how it's considered","normal to walk a venue at","noon for a wedding that","starts at sunset."],
     62, 940, "hook_ig.png")
# TikTok hook - command style, keeps the concrete noon/sunset contrast
card(["Stop walking venues at","noon for sunset weddings."],
     66, 940, "hook_tt.png")
# End card - verbatim from the brief
card(["Save this before your next","venue walkthrough."],
     60, 1330, "endcard.png")
