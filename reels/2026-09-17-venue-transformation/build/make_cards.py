...
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "cards0917")
...
card(["This is the actual","empty room."], 80, 940, "hook_ig.png")
# TikTok hook - command style
card(["Stop showing clients","an empty room."], 74, 940, "hook_tt.png")
