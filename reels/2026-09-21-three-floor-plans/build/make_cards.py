...
# Instagram hook - verbatim from the brief, wrapped to four lines
card(["Two hundred guests, two bars,","a candy bar, a photo booth \u2014","and I couldn't decide","on one layout."], 56, 940, "hook_ig.png")
# TikTok hook - command style, keeps the concrete numbers
card(["Stop settling for","one floor plan.","Two hundred guests, two bars,","a photo booth \u2014 ask for three."], 54, 940, "hook_tt.png")
# End card - verbatim from the brief. Opaque fill so it reads over the layouts.
card(["Save this before your next","big event."], 60, 1330, "endcard.png",
     bg=(0,0,0,240))
